...
#### 4. Grouping and Summarizing
    ...
    -   Calculate summary statistics (e.g., mean and standard deviation) for key measurements such as `Temp` and `pH` across all time points and runs for each feed type.\
...
5.  **Interpreting the Results**
    ...
    -   Discuss how different feed types may be affecting the reactor conditions based on your summary statistics.
